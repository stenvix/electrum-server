...
using Electrum.EventBus.Attributes;
...
namespace Electrum.EventBusRabbitMQ
{
    ...
    {
        public static IBusSubscriber UseRabbitMq(this IApplicationBuilder app) => new BusSubscriber(app.ApplicationServices);
        ...
        public static void AddRabbitMq(this ContainerBuilder builder)
        {
            ...
            {
                var configuration = context.Resolve<IConfiguration>();
                return configuration.GetSection("rabbitMq").Get<RawRabbitConfiguration>();
            });
